...
one_dimensional = matrix_1.reshape(20)
print(one_dimensional)

# flatten -> for convert multidimensional matrix to one dimension
one_dimensional_2 = matrix_1.flatten()
print(one_dimensional_2)
