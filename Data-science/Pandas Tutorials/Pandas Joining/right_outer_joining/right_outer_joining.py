# right outer join
# Syntax:
# new_data_frame_name = pd.merge(df1,df2, on = 'column_name', how = 'right')
...
right_outer_joined_data = pd.merge(personal_data, employee_data, on='id', how='right') [['first_name', 'salary']]
print(right_outer_joined_data)