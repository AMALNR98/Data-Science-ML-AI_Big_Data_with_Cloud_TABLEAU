# full outer join
# Syntax:
# new_data_frame_name = pd.merge(df1,df2, on = 'column_name', how = 'outer')
...
full_outer_joined_data = pd.merge(personal_data, employee_data, on='id', how='outer') [['first_name', 'salary']]
print(full_outer_joined_data)