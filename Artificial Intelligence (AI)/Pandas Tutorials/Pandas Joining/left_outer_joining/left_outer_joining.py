# left outer join
# Syntax:
# new_data_frame_name = pd.merge(df1,df2, on = 'column_name', how = 'left')
...
inner_joined_data = pd.merge(personal_data, employee_data, on='id', how='left')[['first_name', 'salary']]
print(inner_joined_data)
# for mismatching values print NaN
